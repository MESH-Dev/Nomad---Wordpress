(function($) {
  $.fn.tweet = function(o){
    ...
    return this.each(function(i, widget){
      var list = $('<div class="blogRightM">').appendTo(widget);
      ...
      $(widget).bind("load", function(){
        $.getJSON(build_url(), function(data){
          ...
          var tweets = $.map(data.results || data, function(item){
            ...
            var time = '<span class="tweet_time"><a href="'+tweet_url+'" title="'+s.view_text+'">'+tweet_relative_time+'</a></span>';
          ...
          list.append($.map(tweets,
                            function(t) { return '<div class="widget-cloud tweet"><p class="content">' + expand_template(t) + '</p><span class="arrow"></span></div>'; }).join('')).
